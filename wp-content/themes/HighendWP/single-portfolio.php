...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); 
	...
	if ( $header_layout == 'default' )
		$header_layout = highend_option('hb_portfolio_content_layout');
		...
		<div class="container">
			...
			<?php 
				...
				if ( $sidebar_layout == "default" ) {
					$sidebar_layout = highend_option('hb_portfolio_layout'); 
					if ( $sidebar_layout != 'fullwidth')
						$sidebar_position = highend_option('hb_portfolio_sidebar_side');
						...
						<?php if ( $sidebar_position != "") { ?>
							<?php 
								if ( $sidebar_layout == 'wpsidebar' ) {
									...
									<?php if ( highend_option('hb_portfolio_enable_share') || highend_option('hb_portfolio_enable_likes') ) { ?>
									<div class="portfolio-single-shares clearfix">

										<?php if ( highend_option('hb_portfolio_enable_likes') ) { ?>
											<!-- BEGIN .float-left -->
										...
										<?php if ( highend_option('hb_portfolio_enable_share') ) { ?>
										<!-- BEGIN .float-right -->	
