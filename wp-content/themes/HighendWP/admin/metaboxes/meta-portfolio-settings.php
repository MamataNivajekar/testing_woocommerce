...
$hb_portfolio_categories = array(
	array(
		'value' => 'default',
		'label' => esc_html( 'Default', 'hbthemes' ),
	),
	array(
		'value' => 'none',
		'label' => esc_html( 'None', 'hbthemes' ),
	),
);
...
return array(
	array(
		...
		'description' => __('Enter a custom URL that will be opened after clicking on this portfolio item. Enter full URL with https:// prefix. Leave empty to use SINGLE PORTFOLIO PAGE.', 'hbthemes'),
		'default' => "",
	),

	array(
		'type' => 'color',
		'name' => 'hb_portfolio_custom_bg_color',
		'label' => __('Custom Background Hover Color', 'hbthemes'),
		'description' => __('Choose a custom color that will be used when this portfolio is hovered in shortcodes and page templates. Leave empty to use the focus color.', 'hbthemes'),
		'default' => "",
	),
	...
	array(
		'type'        => 'select',
		'name'        => 'hb_portfolio_breadcrumbs',
		'label'       => __( 'Breadcrumbs Category', 'hbthemes' ),
		'description' => __( 'Specify portfolio category to in the breadcrumbs navigation.', 'hbthemes' ),
