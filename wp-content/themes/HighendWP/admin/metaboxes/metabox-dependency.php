...
VP_Security::instance()->whitelist_function('hb_presentation_type_color');
function hb_presentation_type_color( $value ) {
	if ( $value == 'color' ) return true;
	return false;
}

VP_Security::instance()->whitelist_function('hb_presentation_type_image');
function hb_presentation_type_image( $value ) {
	if ( $value == 'image' ) return true;
	return false;
}

VP_Security::instance()->whitelist_function('hb_presentation_type_video');
function hb_presentation_type_video( $value ) {
...
VP_Security::instance()->whitelist_function('hb_featured_image_height');

function hb_featured_image_height( $value ) {
	if (  $value == 'custom-height' ) return true;
	return false;
}
